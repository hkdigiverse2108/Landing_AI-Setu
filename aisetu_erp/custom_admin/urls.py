...
urlpatterns = [
    ...
    path('<str:app_label>/<str:model_name>/export/csv/', views.export_model_csv, name='export_csv'),
    path('<str:app_label>/<str:model_name>/export/pdf/', views.export_model_pdf, name='export_pdf'),
]
