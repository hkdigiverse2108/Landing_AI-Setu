...
from .views import book_demo_api, initiate_payment, payment_callback, login_view,pricing_signup, landing_page_content_api, submit_contact, apply_job, check_referral
from . import views 
urlpatterns = [    
